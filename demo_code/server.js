...
io.on('connection', function(socket) {
  ...
  //socket.emit('serverSaysConnected', 'You are connected to CHAT SERVER')
  ...
  socket.on('clientSaysPrivate', function(data) {
    console.log('RECEIVED: ' + data)
    //to broadcast message to everyone including sender:
    io.emit('serverSaysPrivate', data) //broadcast to everyone including sender
    //alternatively to broadcast to everyone except the sender
    //socket.broadcast.emit('serverSays', data)
  })
